...
use CL\LeagueBundle\Entity\Game;
use CL\LeagueBundle\Form\GameType;
...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CLLeagueBundle:Game')->findAll();

        return $this->render('CLLeagueBundle:Game:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CLLeagueBundle:Game:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CLLeagueBundle:Game')->find($id);
        ...
        return $this->render('CLLeagueBundle:Game:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CLLeagueBundle:Game:edit.html.twig', array(
            'entity'      => $entity,
